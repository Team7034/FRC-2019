...
public class driveTrain extends Subsystem {
	...
	public WPI_TalonSRX talonL3; //these lines disabled for nathan's girl's gen robot testing conveniece
	public WPI_TalonSRX talonR;
	public WPI_TalonSRX talonR2;
	public WPI_TalonSRX talonR3;
    private Timer timer;
    private AHRS gyro; //nathan
    ...
    public void initDefaultCommand() {
		...
		talonL3 = new WPI_TalonSRX(RobotMap.driveL3); //disables for nathan
    	talonR = new WPI_TalonSRX(RobotMap.driveR1); //main right motor
		talonR2 = new WPI_TalonSRX(RobotMap.driveR2);
		talonR3 = new WPI_TalonSRX(RobotMap.driveR3); //nathan
		talonL2.follow(talonL);
		talonL3.follow(talonL); //nathan
		talonR2.follow(talonR);
		talonR3.follow(talonR); //nathan

		//talonR.setInverted(InvertType.InvertMotorOutput);
		
    	talonL.setSelectedSensorPosition(0); //these two lines disabled for nathan
