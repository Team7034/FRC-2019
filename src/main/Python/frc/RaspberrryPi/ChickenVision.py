         ...
         #   cap.autoExpose = True
          #  processed = frame
            ...
            if(networkTable.getBoolean("Tape", True)):
                #this will send the rotation of the tape to the smart dashboard
                SmartDashboard.putNumber("tapeYaw", currentAngleError)
                #this will send the actuall angle needed for the gyro
                ...
                SmartDashboard.putNumber("tapeYaw", 999) 
...
#yaw/2=variable for finding the white line.
#drive to the line and initiate the line follow program